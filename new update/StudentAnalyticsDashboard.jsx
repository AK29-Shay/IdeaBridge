  ...
  return (
    <DashboardLayout title="Dashboard">
      <section className="relative overflow-hidden rounded-[34px] bg-[#110f0c] px-7 py-8 text-[#fecdac] shadow-[0_30px_90px_-42px_rgba(17,15,12,0.92)] sm:px-9">
        ...
        <div className="absolute bottom-[-3rem] right-[22%] h-40 w-40 rounded-full bg-[rgba(214,84,122,0.28)] blur-3xl" />
        <div className="absolute left-[-2rem] top-[-2rem] h-28 w-28 rounded-full bg-white/5 blur-3xl" />
      ...
      {noData ? (
        ...
        <AnalyticsSection projects={filteredProjects} requests={filteredRequests} />
      )}
    </DashboardLayout>
  );
}
