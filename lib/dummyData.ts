...
export const DUMMY_STUDENT_PROJECTS: StudentProject[] = [
  ...
  },
  {
    ...
    progressPercent: 58,
    status: "In Progress",
    milestoneNotes: "Finished the guided mood check-in flow and started training the recommendation prompts. Next: add safety guardrails and counselor escalation rules.",
  ...
  },
  {
    ...
    progressPercent: 81,
    status: "On Track",
    milestoneNotes: "Reservation rules and queue conflict handling are working. Next: optimize slot prediction and add lecturer approval history.",
  ...
  },
  {
    ...
    progressPercent: 47,
    status: "In Progress",
    milestoneNotes: "Built the dashboard for weekly goals, mock interview tracking, and recruiter activity snapshots. Next: connect reminders and progress badges.",
  ...
  },
  {
    ...
    progressPercent: 23,
    status: "Delayed",
    milestoneNotes: "Route comparison logic is drafted, but transport datasets still need cleanup before reliable scoring can be shown in the UI.",
  ...
  },
  {
    ...
    progressPercent: 12,
    status: "Not Started",
    milestoneNotes: "Initial concept, matching criteria, and user personas are drafted. Need validation on moderation rules and mentor oversight model.",
  ...
  },
  {
    ...
    progressPercent: 88,
    status: "On Track",
    milestoneNotes: "Recommendation cards, event tagging, and interest-based filtering are nearly done. Final step is polishing accessibility and RSVP reminders.",
