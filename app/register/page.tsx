...
export default function RegisterPage() {
  ...
  async function onSubmit(values: RegisterInput) {
    try {
      ...
      const newUser: Omit<AuthUser, "id" | "user_id"> = {
        role: values.role,
      ...
      const rawMessage = e instanceof Error ? e.message : "Registration failed.";
      const normalized = rawMessage.toLowerCase();

      if (normalized.includes("rate limit")) {
        toast.error("Too many signup attempts right now. Please wait about a minute, or use Login if this account already exists.");
      } else {
